@echo off
title Creando Ejecutable con Frontend
color 0A

echo ========================================
echo    Creando Ejecutable con Frontend
echo ========================================
echo.

REM Crear un archivo temporal con mejor manejo de rutas
echo Creando server-con-frontend.js...
(
...
echo   });
echo });
) > server-con-frontend.js

echo Archivo server-con-frontend.js creado.
echo.

REM Crear el ejecutable mejorado
echo Creando ejecutable con frontend...
pkg server-con-frontend.js --target node18-win-x64 --output SistemaEstimulacionConFrontend.exe

if %errorlevel% equ 0 (
    echo.
    echo ========================================
    echo    Ejecutable con frontend creado!
    echo ========================================
    echo.
    echo Archivo: SistemaEstimulacionConFrontend.exe
    echo.
    echo Características:
    echo - Manejo correcto de archivos frontend
    echo - Servir archivos estáticos desde carpeta app
    echo - Ruta de verificación /api/health
