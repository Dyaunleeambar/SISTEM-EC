...
const db = mysql.createConnection({
    ...
    database: 'colaboradores_db' // Cambia por el nombre de tu base de datos
});

// Crea la base de datos y la tabla si no existen
db.query(`CREATE DATABASE IF NOT EXISTS colaboradores_db`, (err) => {
    if (err) throw err;
    db.query(`USE colaboradores_db`);
    db.query(`
